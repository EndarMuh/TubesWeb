                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <center><i class="fa fa-paw" > LOGIN</i></center>
                                </div>
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <h6 class="text-center font-weight-light my-">belum punya akun? <a href="register.php" class="text-info">silahkan daftar</a></h6>
                                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-primary1" name="login">Login</button>
                                        </div>
                                        <br/>
